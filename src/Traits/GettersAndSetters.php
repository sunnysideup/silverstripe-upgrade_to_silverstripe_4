        ...
        public function __call($function, $args)
        {
            ...
            if ($getOrSet === 'set' || $getOrSet === 'get') {
                ...
                if (property_exists($this, $var)) {
                    ...
                    user_error('Fatal error: can not get/set variable in ModuleUpgraderBaseWithVariables::' . $var, E_USER_ERROR);
                }
            } else {
                user_error('Fatal error: Call to undefined method ModuleUpgraderBaseWithVariables::' . $function . '()', E_USER_ERROR);
            }
        }
